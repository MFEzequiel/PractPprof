...
const btInfo = $('.info-aditional-hamburger')
const infoAditionale = $('.info-aditional')
const containerInfo = $('.container-info-aditional')
...
btInfo-addEventListener('click', () => {
  const clInfo = infoAditionale.classList
  const conInfo = containerInfo.classList
  
  clInfo.toggle('info-aditional-active')
  conInfo.toggle('container-info-aditional-active')
})
